...
namespace darcel {
  ...
  */
  using ExpressionBuilder = std::function<
  ...
  */
  inline std::unique_ptr<BindEnumStatement> bind_enum(Location l, Scope& s,
      std::string name, std::vector<EnumDataType::Symbol> symbols) {
    auto type = std::make_shared<EnumDataType>(std::move(l), std::move(name),
      std::move(symbols));
    s.add(type);
    return std::make_unique<BindEnumStatement>(std::move(type));
  }
  ...
  */
  inline std::unique_ptr<BindFunctionStatement> bind_function(Location l,
    ...
    auto f = [&] {
      ...
      if(f == nullptr) {
        throw RedefinitionSyntaxError(l, name,
    ...
    return std::make_unique<BindFunctionStatement>(std::move(l), std::move(f),
  ...
  /*!
    ...
    \param body The function called to build the body of the function.
  */
  inline std::unique_ptr<BindFunctionStatement> bind_function(Scope& s,
      std::string name,
      std::vector<BindFunctionStatement::parameter> parameters,
      const ExpressionBuilder& body) {
  ...
  */
  inline std::unique_ptr<BindFunctionStatement> bind_function(Scope& s,
      ...
      const ExpressionBuilder& body) {
    std::vector<BindFunctionStatement::parameter> p;
    for(auto& parameter : parameters) {
  ...
  */
  inline std::unique_ptr<BindFunctionStatement> bind_function(Scope& s,
      std::string name, const ExpressionBuilder& body) {
    std::vector<BindFunctionStatement::parameter> p;
    return bind_function(Location::global(), s, std::move(name), std::move(p),
      body);
  }
  ...
  */
  inline std::unique_ptr<BindVariableStatement> bind_variable(Location l,
    ...
    s.add(v);
    return std::make_unique<BindVariableStatement>(std::move(l), std::move(v),
      std::move(e));
  }
  ...
  /*!
    ...
    \param e The expression to bind to the variable.
  */
  inline std::unique_ptr<BindVariableStatement> bind_variable(Scope& s,
  ...
  */
  inline std::unique_ptr<CallExpression> call(Location l,
      std::unique_ptr<Expression> callable,
      std::vector<std::unique_ptr<Expression>> arguments) {
    return std::make_unique<CallExpression>(l, std::move(callable),
      std::move(arguments));
  }
  ...
  */
  inline std::unique_ptr<CallExpression> call(Location l, const Scope& s,
  ...
  /*!
    ...
    \param arguments The list of arguments to pass to the function.
  */
  inline std::unique_ptr<CallExpression> call(const Scope& s, std::string name,
      std::vector<std::unique_ptr<Expression>> arguments) {
  ...
  /*!
    ...
    \param s The scope to find the function in.
  */
  inline std::unique_ptr<CallExpression> call(const Scope& s,
      std::string name) {
  ...
  */
  inline std::unique_ptr<LiteralExpression> make_literal(Location l,
      bool value) {
    std::string v = [&] {
      if(value) {
        return "true";
    ...
    return std::make_unique<LiteralExpression>(std::move(l),
  ...
  /*!
    \param value The value to represent.
  */
  inline std::unique_ptr<LiteralExpression> make_literal(bool value) {
  ...
  */
  ...
  /*!
    \param value The value to represent.
  */
  inline std::unique_ptr<LiteralExpression> make_literal(int value) {
    return make_literal(Location::global(), value);
  }
  ...
  /*!
    ...
    \param value The value to represent.
  */
  inline std::unique_ptr<LiteralExpression> make_text(Location l,
      std::string value) {
    return std::make_unique<LiteralExpression>(std::move(l),
  ...
  /*!
    \param value The value to represent.
  */
  inline std::unique_ptr<LiteralExpression> make_text(std::string value) {
  ...
  */
  inline std::unique_ptr<VariableExpression> make_variable_expression(
      Location l, const Scope& s, const std::string& name) {
    auto v = s.find<Variable>(name);
    if(v == nullptr) {
      throw VariableNotFoundError(l, name);
    }
    return std::make_unique<VariableExpression>(l, std::move(v));
  }
  ...
  */
  inline std::unique_ptr<Expression> find_term(Location l, const Scope& s,
    ...
    if(auto f = std::dynamic_pointer_cast<Function>(e)) {
      return std::make_unique<FunctionExpression>(std::move(l), std::move(f));
    } else if(auto v = std::dynamic_pointer_cast<Variable>(e)) {
      return std::make_unique<VariableExpression>(std::move(l), std::move(v));
    }
    throw VariableNotFoundError(l, name);
  }
